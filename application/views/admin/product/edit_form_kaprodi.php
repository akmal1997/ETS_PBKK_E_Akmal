				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php base_url(" admin/product/edit") ?>" method="post"
                            ...
                            <div class="form-group">
								<label for="name">Dosen Pembimbing 1</label>
								<input class="form-control <?php echo form_error('dosbing1') ? 'is-invalid':'' ?>"
								 type="text" name="dosbing1" min="0" placeholder="Dosen Pembimbing 1" value="<?php echo $product->dosbing1 ?>" />
								<div class="invalid-feedback">
									<?php echo form_error('dosbing1') ?>
								</div>
							</div>

                            <div class="form-group">
								<label for="name">Dosen Pembimbing 2</label>
								<input class="form-control <?php echo form_error('dosbing2') ? 'is-invalid':'' ?>"
								 type="text" name="dosbing2" min="0" placeholder="Dosen Pembimbing 1" value="<?php echo $product->dosbing2 ?>" />
								<div class="invalid-feedback">
									<?php echo form_error('dosbing2') ?>
								</div>
							</div>
